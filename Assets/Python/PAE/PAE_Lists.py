...
def init():
		...
		DGGNames = {
			...
			gc.getInfoTypeForString("CIVILIZATION_ISRAEL"):
			["Jonathan", "Judas Makkabaeus", "Bar Kochbar", "Jason",
			 "Justasas", "Schimon bar Giora", "Simon Makkabaeus", "Samson",
			 "Johann Gischala", "Barak", "Patricius", "Judas", "Hezekia",
			 "Abner", "Scheba", "Jaobs", "Jacok", "David", "Ismel",
			 "Benaja", "Omri", "Simon", "Ismael", "Isaac", "Saul", "Jeha",
			 "Goliath", "Abraham", "Isaak", "Jakob", "Aaron", "Salomo",
