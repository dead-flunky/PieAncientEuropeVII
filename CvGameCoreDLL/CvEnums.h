...
enum ButtonPopupTypes			// Exposed to Python
{
	...
	BUTTONPOPUP_CONFIRM_MENU_KI, // PBMod
...
enum GameOptionTypes				// Exposed to Python
{
	...
	GAMEOPTION_NO_DISASTERS, // PAE
	GAMEOPTION_NO_MULTIPLE_PRODUCTION, //Multiple Production: by Denev 07/10/2009
	GAMEOPTION_NO_PAE_COMBAT, // PAE: battle rounds
...
enum FeatTypes						// Exposed to Python
{
	...
	FEAT_POPULATION_25K,
	FEAT_POPULATION_50K,
	FEAT_POPULATION_100K,
	FEAT_POPULATION_250K,
...
enum GameMessageTypes				// Exposed to Python
{
	...
	GAMEMESSAGE_TURN_INCOMPLETE		// PBMod
};
...
enum AdvancedStartActionTypes				// Exposed to Python
{
	...
	ADVANCEDSTARTACTION_EXIT_CONFIRM	// PBMod
};
