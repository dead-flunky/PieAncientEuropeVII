...
void CyEnumsPythonInterface()
{
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_NO_MULTIPLE_PRODUCTION", GAMEOPTION_NO_MULTIPLE_PRODUCTION) // Multiple Production: by Denev 07/10/2009
		.value("GAMEOPTION_NO_PAE_COMBAT", GAMEOPTION_NO_PAE_COMBAT) // PAE battle rounds
