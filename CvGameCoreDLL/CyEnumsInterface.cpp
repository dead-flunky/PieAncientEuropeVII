...
void CyEnumsPythonInterface()
{
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_NO_DISASTERS", GAMEOPTION_NO_DISASTERS) // PAE
	...
	python::enum_<PlayerOptionTypes>("PlayerOptionTypes")
		...
		.value("PLAYEROPTION_SHOW_ENEMY_MOVES_PAE_AGGRESSIVE_ANIMALS", PLAYEROPTION_SHOW_ENEMY_MOVES_PAE_AGGRESSIVE_ANIMALS)
		.value("PLAYEROPTION_SHOW_ENEMY_MOVES_PAE_FRIENDLY_ANIMALS", PLAYEROPTION_SHOW_ENEMY_MOVES_PAE_FRIENDLY_ANIMALS)
	...
	python::enum_<FeatTypes>("FeatTypes")
		...
		.value("FEAT_POPULATION_1K", FEAT_POPULATION_1K)
		.value("FEAT_POPULATION_5K", FEAT_POPULATION_5K)
		.value("FEAT_POPULATION_10K", FEAT_POPULATION_10K)
		.value("FEAT_POPULATION_25K", FEAT_POPULATION_25K)
		.value("FEAT_POPULATION_50K", FEAT_POPULATION_50K)
		.value("FEAT_POPULATION_100K", FEAT_POPULATION_100K)
		.value("FEAT_POPULATION_250K", FEAT_POPULATION_250K)
